---
title: List of all Mesh Technologies | PGV Mesh
description: PGV Mesh is a technology agnostic group. Let's explore all of the various mesh technologies together!
---

<hgroup>
  <h1>Mesh Technology</h1>
  <p>PGV Mesh currently uses only a few(MeshCore and Meshtastic) mesh technologies out of <i>many</i>. This page is a place to compare and understand the various technologies. More technologies will be added here over time. For now, we start with APRS on ham radio.</p>
</hgroup>
